...
int main(void)
{
    ...
    // In float precision: nvcc -O3 -arch=sm_75 add3memcpy.cu -o add3memcpy.out
    // In real precision: nvcc -O3 -arch=sm_75 -DUSE_DP add3memcpy.cu -o add3memcpy.out
    // Run exe file: nsys profile --stats=true ./add3memcpy.out

...
int main(void)
{
    ...
    // In float precision: nvcc -O3 -arch=sm_75 reduce1static.cu -o reduce1static.out
    // In double precision: nvcc -O3 -arch=sm_75 -DUSE_DP reduce1static.cu -o reduce1static.out
    // Run exe file: cuda-memcheck ./reduce1static.out

...
int main(void)
{
    ...
    // In float precision: nvcc -O3 -arch=sm_75 host_kernel.cu -o host_kernel.out
    // In double precision: nvcc -O3 -arch=sm_75 -DUSE_DP host_kernel.cu -o host_kernel.out
    // Run exe file: cuda-memcheck ./host_kernel.out

...
int main(void)
{
    ...
    // In float precision: nvcc -O3 -arch=sm_75 kernel_transfer.cu -o kernel_transfer.out
    // In real precision: nvcc -O3 -arch=sm_75 -DUSE_DP kernel_transfer.cu -o kernel_transfer.out
    // Run exe file: cuda-memcheck ./kernel_transfer.out

...
int main(void)
{
    ...
    // In float precision: nvcc -O3 -arch=sm_75 kernel_kernel.cu -o kernel_kernel.out
    // In real precision: nvcc -O3 -arch=sm_75 -DUSE_DP kernel_kernel.cu -o kernel_kernel.out
    // Run exe file: cuda-memcheck ./kernel_kernel.out
